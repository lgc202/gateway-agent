...
> 阅读提示：本文记录 Chat/Message 基础能力当时如何设计和实现。下一步目标 Schema 已由 [05-输入规范化与可靠执行设计](./05-输入规范化与可靠执行设计.md) 扩展；涉及 chat_messages.task_id、幂等字段、Task、Run、Event 和 Outbox 时以 05 为准。
